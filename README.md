...
El registro de cuenta es simple, la aplicación pide ingresar; nombre, email y una password. 
...
A continuación se enlistan las versiones y dependencias que fueron utilizadas para el desarrollo de esta aplicación
